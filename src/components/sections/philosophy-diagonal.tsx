...
/**
 * Philosophy — Variation 2: Logo watermark.
 * Oversized brand mark bleeding off the top-right corner (like the diagonal wash).
 */
const PhilosophyDiagonal = () => {
  ...
  return (
    <Section
      id="philosophy-diagonal"
      size="lg"
      variant="default"
      className="relative overflow-hidden"
    >
      {/* Logo watermark bleeding off the top-right corner.
          Rendered as a mask filled with --foreground so it tracks the theme. */}
      <div
        aria-hidden="true"
        className="absolute -top-32 -right-40 w-[700px] h-[700px] pointer-events-none opacity-[0.06] bg-foreground"
        style={{
          maskImage: 'url(/logo-watermark.svg)',
          WebkitMaskImage: 'url(/logo-watermark.svg)',
        ...
        <div ref={sectionRef}>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center">
            <Stack gap="lg" className="phi-text lg:col-span-12 xl:col-span-5">
              <p className="label text-accent">Our Conviction · Watermark</p>
...
export default PhilosophyDiagonal
