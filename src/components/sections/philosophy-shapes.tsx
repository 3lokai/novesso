...
/**
 * Philosophy — Variation 3: Floating geometric shapes.
 * Abstract rotated square + circle outlines drifting in the background.
 */
const PhilosophyShapes = () => {
  ...
  return (
    <Section
      id="philosophy-shapes"
      size="lg"
      variant="default"
      className="relative overflow-hidden"
    >
      {/* Floating geometric accents (foreground + gold track the theme) */}
      <div className="absolute inset-0 pointer-events-none opacity-[0.08]">
        {/* Top-left square */}
        <div
          className="absolute top-20 left-10 w-96 h-96 border border-foreground"
          style={{ transform: 'rotate(12deg)' }}
        />
        {/* Bottom-right circle */}
        <div className="absolute bottom-32 right-20 w-[500px] h-[500px] rounded-full border border-accent" />
      </div>
        ...
        <div ref={sectionRef}>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center">
            <Stack gap="lg" className="phi-text lg:col-span-12 xl:col-span-5">
              <p className="label text-accent">Our Conviction · Shapes</p>
...
export default PhilosophyShapes
